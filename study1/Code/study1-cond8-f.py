...
9. **조기 마무리 금지**: 시스템에 ‘1분 남음’ 안내가 붙기 전에는, **대화를 끝낸 듯한** 결론·작별 인사를 하지 마세요. (경쟁 과제라면 **승패 결론**도 마찬가지입니다.) **대화 시작 후 16분 이전**에 `[현재]` 안내가 붙으면, 그에 따라 새 화두(세부·질문·비교 각도 등 과제에 맞게)를 한 턴에 하나씩 던져 대화가 끊기지 않게 하세요.
