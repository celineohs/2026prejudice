# -*- coding: utf-8 -*-
"""
study1-test: 연구자용 테스트 앱. study1-cond1과 동일 로직·프롬프트, 대화 타이머만 1분.
"""
...
CHAT_DURATION = 60  # 테스트: 1분
SAVE_PREFIX = "study1-test"
...
def page_intro():
    ...
    st.caption("연구자용 짧은 타이머 테스트입니다. 본 실험(cond1)과 동일한 흐름·저장·Drive 업로드 로직을 사용합니다.")
    st.markdown(
        """
---
...
**[테스트]** 앞으로 **1분** 간, 귀하께서는 채팅을 통해 아래 과제에 참여하게 될 예정입니다.  
...
- 가능한 한 **두 사람 모두 동의할 수 있는** 하나의 부스안을 만드는 것이 목표입니다.
    ...
    if rem <= 15:
        effective_system = effective_system + "\n\n[현재] 대화 시간이 거의 끝났습니다. 한두 문장으로 자연스럽게 마무리 인사해 주세요."
